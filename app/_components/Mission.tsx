        ...
        <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
          <div className="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
            ...
            <p className="mt-6 text-base leading-7 text-gray-300">
              ...
              and hassle-free as possible. That's why we've developed a platform
              that allows restaurant owners to manage their menu, tables, and
              orders all in one place. Our goal is to provide a seamless
              experience for both restaurant owners and their customers, so that
              everyone can focus on what really matters: delicious food and
              great service.
            </p>
          </div>
        </div>
